...
Once you generate a pull request, GitHub and third-party apps will verify if the changes are suitable to be merged with upstream. [Travis](https://travis-ci.org/hfreire/cloudwatch-alarm-to-slack) will verify your changes for style guide violations and failing test cases, while, [Coveralls](https://coveralls.io/github/hfreire/cloudwatch-alarm-to-slack) will verify the coverage of the automated test cases against the code.
